...
import { Stack, Card, CardContent, Typography, CardActions, CardMedia, Button, Chip, Box, ButtonGroup } from '@mui/material'
            ...
            {FARMERS.map(farmer => {
                ...
                return (
                    <Card raised sx={{ maxWidth: '90%' }}>
                        ...
                        <CardActions>
                            <ButtonGroup>
                            <Button target="_blank" rel="noreferrer" href={website} startIcon={<OpenInNewIcon />}>
                                Website
                            </Button>
                            <Button target="_blank" rel="noreferrer" href={facebook} startIcon={<FacebookIcon />}>
                                Facebook
                            </Button>
                            <Button target="_blank" rel="noreferrer" href={instagram} startIcon={<InstagramIcon />}>
                                Instagram
                            </Button>
                            </ButtonGroup>
                        </CardActions>
